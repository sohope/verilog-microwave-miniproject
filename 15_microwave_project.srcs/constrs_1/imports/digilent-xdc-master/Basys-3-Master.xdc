...
# btn[0]: btnL, btn[1]: btnC, btn[2]: btnR, btn[3]: btnD, btn[4]: btnU
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {dc_motor_pwm}];#Sch name = JA1
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {servo_motor_pwm}];#Sch name = JB1
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {buzzer_pwm}];#Sch name = JB2
